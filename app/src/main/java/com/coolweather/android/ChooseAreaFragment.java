...
public class ChooseAreaFragment extends Fragment {
    ...
    private void queryProvinces() {
        ...
        provinceList = LitePal.findAll(Province.class); //替换DataSupport.findAll(Province.class);
        ...
        HttpUtil.sendOkHttpRequest(address, new Callback() {
            ...
            public void onResponse(@NonNull Call call, @NonNull Response response) throws IOException {
                ...
                if ("province".equals(type)) {
                    ...
                    result = Utility.handleCityResponse(requestText, selectedProvince.getId());
                } else if ("county".equals(type)) {
                    result = Utility.handleCountyResponse(requestText, selectedCity.getId());
                }
                if (result) {
                    getActivity().runOnUiThread(() -> {
                        closeProgressDialog();
